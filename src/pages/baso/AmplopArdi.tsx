...
import rekBaso from "./../../assets/cardBasoBni.png";
import rekHusni from "./../../assets/cardHusniBri.png";
...
export default function AmplopArdi() {
  ...
  const rek1 = "493701027202539";
  const rek2 = "1361672191";
      ...
      <div className="secPositionHome">
        ...
        >
          ...
          <div className={openAmplop ? "cardardiBank active" : "cardardiBank"}>
            <img src={rekHusni} alt="rek husni" className={"rekIndricard"} />
          ...
          <div className={openAmplop ? "cardardiBank active" : "cardardiBank"}>
            <img src={rekBaso} alt="rek baso" className={"rekIndricard"} />
            <div className="copyTextArdi" onClick={() => handleCopyText(rek2)}>
              <h3>Copy</h3>
              <img src={copy} alt="copy text" style={{ width: "20%" }} />
              <div className={`notificationArdi ${copiedMessage && "show"}`}>
                {copiedMessage}
